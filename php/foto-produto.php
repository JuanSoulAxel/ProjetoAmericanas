...
if(isset($_FILES['produto'])) //verificar se usuário enviou produto
{
    ...
    para nosso diretorio criado acima e dar o novo nome a ele também criado a cima ou seja,  na primeira parte  a gente acessa o diretório e na segunda parte a gente copia para o nosso diretório move_uploaded_file($_FILES['produto']['tmp_name'], $diretorio.$novo_nome);*/
    $adm->cadastrarProduto($novo_nome, $descricao, $preco_final, $preco_antigo, $porcentagem); 
}
else 
{ 
